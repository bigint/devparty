...
const FeedType: React.FC<Props> = (props: Props) => {
  return (
    <div className="flex gap-3 px-2 sm:px-0">
      <button
        ...
        onClick={() => props.setFeedType('ALL')}
      >
        <GlobeIcon className="h-4 w-4" />
        <div className={props.feedType === 'ALL' ? '' : `hidden sm:block`}>
          All
        </div>
      </button>
      <button
        ...
        onClick={() => props.setFeedType('POST')}
      >
        <CollectionIcon className="h-4 w-4" />
        <div className={props.feedType === 'POST' ? '' : `hidden sm:block`}>
          Posts
        </div>
      </button>
      <button
        ...
        onClick={() => props.setFeedType('TASK')}
      >
        <CheckCircleIcon className="h-4 w-4" />
        <div className={props.feedType === 'TASK' ? '' : `hidden sm:block`}>
          Tasks
        </div>
      </button>
      <button
        ...
        onClick={() => props.setFeedType('QUESTION')}
      >
        <QuestionMarkCircleIcon className="h-4 w-4" />
        <div className={props.feedType === 'QUESTION' ? '' : `hidden sm:block`}>
          Question
        </div>
      </button>
    </div>
