...
const Search: React.FC = () => {
  ...
  return (
    <>
      <input
        className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 focus:border-purple-500 focus:ring-purple-400 outline-none rounded-lg shadow-sm w-full py-1.5"
        type="text"
